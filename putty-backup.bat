...
REM Author				: ayid
REM Created			: 20th-June-2020
REM Last Modified	: 2020
REM Version				: 1.1
REM Modifications		: 1.1 - 2020 - Edited the script to create variables for the filename and the registry key
